...
| `v`                 | Enter visual mode (pause autoscroll; anchor at cursor) |
| `y`                 | Copy selected lines (visual mode only; exits visual mode and resumes autoscroll) |
| `esc`               | Exit visual mode (resume autoscroll)                |
